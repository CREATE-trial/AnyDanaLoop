...
class ConstraintsCheckerTest : TestBaseWithProfile() {
    ...
    fun prepare() {
        ...
        `when`(resourceHelper.gs(R.string.stagenotstarted)).thenReturn("Stage %d not started")
        ...
        stagesPlugin = StagesPlugin(injector, aapsLogger, resourceHelper, activePlugin, sp, Config())
        ...
        constraintsPluginsList.add(stagesPlugin)
    ...
    fun isLoopInvocationAllowedTest() {
        ...
        Assert.assertEquals(true, c.reasonList.size == 2) // Combo & Stages
        Assert.assertEquals(true, c.mostLimitedReasonList.size == 2) // Combo & Stages
    ...
    fun isAutosensModeEnabledTest() {
        ...
        Assert.assertEquals(true, c.reasonList.size == 2) // Safety & Stages
        Assert.assertEquals(true, c.mostLimitedReasonList.size == 2) // Safety & Stages
        Assert.assertEquals(java.lang.Boolean.FALSE, c.value())
    }
