...
class SWEditNumber(injector: HasAndroidInjector, private val init: Double, private val min: Double, private val max: Double) : SWItem(injector, Type.UNITNUMBER) {
    ...
    override fun generateDialog(layout: LinearLayout) {
        ...
        val numberPicker = NumberPickerVertical(context)
        numberPicker.setParams(initValue, min, max, 1.0, DecimalFormat("0"), false, null, watcher)
