...
class WizardDialog : DaggerDialogFragment() {
    ...
    private fun loadCheckedStates() {
        ...
        treatments_wizard_cobcheckbox.isChecked = sp.getBoolean(resourceHelper.gs(R.string.key_wizard_include_cob), true)
    }
    ...
    private fun initDialog() {
        ...
        treatments_wizard_cobcheckbox.isChecked = true;
        var cob = 0.0
        //COB calculation

        val cobdat = iobCobCalculatorPlugin.getCobInfo(false, "Wizard COB")

        cobdat.displayCob?.let { cob = it }
