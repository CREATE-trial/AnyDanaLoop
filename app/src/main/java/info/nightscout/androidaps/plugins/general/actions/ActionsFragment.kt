...
class ActionsFragment : DaggerFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sp.putBoolean(R.string.key_stageuseactions, true)

        if (!buildHelper.isEngineeringMode()) {

            actions_settempbasal?.visibility = View.GONE
            actions_canceltempbasal?.visibility = View.GONE
            actions_announcement?.visibility = View.GONE
            actions_extendedbolus?.visibility = View.GONE
            actions_extendedbolus_cancel?.visibility = View.GONE
            actions_bgcheck?.visibility = View.GONE
            actions_note?.visibility = View.GONE
            actions_question?.visibility = View.GONE
            actions_exercise?.visibility = View.GONE
        }
    }
