...
class PrefFileListProvider @Inject constructor(
    ...
    companion object {
        ...
        private val aapsPath = File(path, "ADL" + File.separator + "preferences")
    ...
    fun formatExportedAgo(utcTime: String): String {
        ...
        return if (hours == 0) {
            ...
            resourceHelper.gs(R.string.exported_ago, resourceHelper.gq(R.plurals.stage_hours, hours, hours))
        } else if ((days < IMPORT_AGE_NOT_YET_OLD_DAYS) && (days > 0)) {
            resourceHelper.gs(R.string.exported_ago, resourceHelper.gq(R.plurals.stage_days, days, days))
        } else {
