                    ...
                    if (resultAfterConstraints.isCarbsRequired()
                        ...
                        if (sp.getBoolean(R.string.key_enable_carbs_required_alert_local,true) && sp.getBoolean(R.string.key_raise_notifications_as_android_notifications, true)){
                            ...
                            NotificationCompat.Action actionIgnore5m = new
                                    NotificationCompat.Action(R.drawable.ic_notif_adl, resourceHelper.gs(R.string.ignore5m,"Ignore 5m"), pendingIntent5m);
                            ...
                            NotificationCompat.Action actionIgnore15m = new
                                    NotificationCompat.Action(R.drawable.ic_notif_adl, resourceHelper.gs(R.string.ignore15m,"Ignore 15m"), pendingIntent15m);
                            ...
                            NotificationCompat.Action actionIgnore30m = new
                                    NotificationCompat.Action(R.drawable.ic_notif_adl,  resourceHelper.gs(R.string.ignore30m,"Ignore 30m"), pendingIntent30m);
        ...
        applyTBRRequest(lastRun.getConstraintsProcessed(), profile, new Callback() {
            ...
            public void run() {
                if (result.enacted) {
                    ...
                    sp.incInt(R.string.key_StagesmanualEnacts);
                }
