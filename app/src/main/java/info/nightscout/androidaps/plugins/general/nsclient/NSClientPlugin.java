...
public class NSClientPlugin extends PluginBase {
    ...
    public void preprocessPreferences(@NotNull PreferenceFragmentCompat preferenceFragment) {
        ...
        int engineerprefkeys[] = {
                R.string.key_ns_wifionly,
                R.string.key_ns_allowroaming,
                R.string.key_ns_chargingonly,
                R.string.key_ns_autobackfill,
                R.string.key_ns_create_announcements_from_errors

        };

        for (int i=0; i<engineerprefkeys.length; i++) {
            Preference pref = preferenceFragment.findPreference(resourceHelper.gs(engineerprefkeys[i]));
