...
class HardLimits @Inject constructor(
    ...
    val MAXBOLUS = doubleArrayOf(20.0, 30.0, 30.0, 40.0)
    ...
    val MAXDIA = doubleArrayOf(7.0, 7.0, 7.0, 7.0)
    val MINIC = doubleArrayOf(2.0, 2.0, 2.0, 2.0)
    val MAXIC = doubleArrayOf(100.0, 100.0, 100.0, 100.0)
    val MINISF = 2.0 // mgdl
    val MAXISF = 720.0 // mgdl
    val MAXIOB_SMB = doubleArrayOf(20.0, 30.0, 30.0, 40.0)
    val MAXBASAL = doubleArrayOf(5.0, 10.0, 10.0, 12.0)
