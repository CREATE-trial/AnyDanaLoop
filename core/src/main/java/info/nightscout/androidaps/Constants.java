...
public class Constants {
    ...
    public static final double defaultmaxBolus = 3d;
    public static final double defaultmaxCarbs = 48d;
    public static final double limitmaxmaxCarbs = 200d;
    public static final double limitminmaxCarbs = 1d;
    public static final double limitminmaxBolus = 0.1d;
    public static final double limitmaxmaxBolus = 25d;
    ...
    // Temp targets
    public static final int defaultActivityTTDuration = 120; // min
    public static final double defaultActivityTTmgdl = 140d;
    public static final double defaultActivityTTmmol = 8d;
    public static final int defaultEatingSoonTTDuration = 60; // min
    public static final double defaultEatingSoonTTmgdl = 80d;
    public static final double defaultEatingSoonTTmmol = 4.5d;
    public static final int defaultHypoTTDuration = 30; // min
    public static final double defaultHypoTTmgdl = 117d;
    public static final double defaultHypoTTmmol = 6.5d;
    public static final double defaultCustomTTmgdl = 108d;
    public static final double defaultCustomTTmmol = 6.0d;
    public static final int defaultCustomTTDuration = 60; //min
    ...
    // Overview
    public static final double LOWMARK = 70.2;
    ...
    public static final String APP_Password = "a28ijmd$%dFGB%CXawd*";
}
