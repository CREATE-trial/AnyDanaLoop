...
public class BgReading implements DataPointWithLabelInterface {
    ...
    public int getColor() {
        ...
        else if (valueToUnits(units) > (highLine*2.6))
            color = resourceHelper.gc(R.color.above360);
        else if (valueToUnits(units) > (highLine*2.4))
            color = resourceHelper.gc(R.color.above340);
        else if (valueToUnits(units) > (highLine*2.2))
            color = resourceHelper.gc(R.color.above300);
        else if (valueToUnits(units) > (highLine*2))
            color = resourceHelper.gc(R.color.above280);
        else if (valueToUnits(units) > (highLine*1.80))
            color = resourceHelper.gc(R.color.above260);
        else if (valueToUnits(units) > (highLine*1.70))
            color = resourceHelper.gc(R.color.above240);
        else if (valueToUnits(units) > (highLine*1.60))
            color = resourceHelper.gc(R.color.above200);
        else if (valueToUnits(units) > (highLine*1.50))
            color = resourceHelper.gc(R.color.above190);
        else if (valueToUnits(units) > (highLine*1.40))
            color = resourceHelper.gc(R.color.above180);
        else if (valueToUnits(units) > (highLine*1.30))
            color = resourceHelper.gc(R.color.above170);
        else if (valueToUnits(units) > (highLine*1.20))
            color = resourceHelper.gc(R.color.above160);
        else if (valueToUnits(units) > (highLine*1.15))
            color = resourceHelper.gc(R.color.above150);
        else if (valueToUnits(units) > (highLine*1.10))
            color = resourceHelper.gc(R.color.above140);
        else if (valueToUnits(units) > (highLine) )
            color = resourceHelper.gc(R.color.above135);
        else if (valueToUnits(units) > (highLine*0.80))
            color = resourceHelper.gc(R.color.above125);
        else if (valueToUnits(units) > (highLine*0.65))
            color = resourceHelper.gc(R.color.above100);
        else if (valueToUnits(units) > (lowLine*1.20))
            color = resourceHelper.gc(R.color.above70);
        else if (valueToUnits(units) > lowLine)
            color = resourceHelper.gc(R.color.above66);
        else if (valueToUnits(units) < lowLine)
            color = resourceHelper.gc(R.color.lower66);
